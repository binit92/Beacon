...
Public Class TspForm
    ...
    Private Sub btnSavePicture_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSavePicture.Click
        ...
        MsgBox("Pictue Downloaded in .bmp .jpg and .gif image in the directory")
    End Sub
    ...
    ''' <param name="sender">Object that generated this event.</param>
    ''' <param name="e">Event arguments.</param>
    Private Sub clearCityListButton_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles clearCityListButton.Click
        If tsp IsNot Nothing Then
            StatusLabel.Text = "Cannot alter city list while running"
            StatusLabel.ForeColor = Color.Red
            Return
        ...
        cityList.Clear()
        Me.DrawCityList(cityList)
    End Sub

    Private Sub openCityListButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles openCityListButton.Click
        ...
        Try
            ...
            fileName = Me.fileNameTextBox.Text
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ' Create xml writer setting
        Dim settings As XmlWriterSettings = New XmlWriterSettings
        settings.Indent = True
        ' create xml writer
        Dim filename As String = TextBox1.Text
        Dim path As String = "C:\Beacon\" + filename + ".xml"
        Using writer As XmlWriter = XmlWriter.Create(path, settings)
            ...
            ' Loop over cities in array 
            Dim i As Point
            For l_index As Integer = 0 To ListBox1.Items.Count - 1
                Dim coordi As Point = ListBox1.Items(l_index)
                Dim string1 As String = "X=" + coordi.X.ToString + " Y=" + coordi.Y.ToString
                'writer.WriteStartAttribute("City", string1)
                MessageBox.Show(string1)
               
                writer.WriteStartElement("City")
                writer.WriteAttributeString("X", coordi.X.ToString)
                writer.WriteAttributeString("Y", coordi.Y.ToString)
            ...
            ' writer.WriteEndDocument()
            MessageBox.Show("File created successfuly at" + path)
       

        End Using
    End Sub

    Private Sub tourDiagram_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PictureBox1.MouseMove
        PictureBox1.Select()

    End Sub

    Private Sub tourDiagram_MouseWheel(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PictureBox1.MouseWheel
        If e.Delta <> 0 Then
            If e.Delta <= 0 Then
                If PictureBox1.Width < 587 Then Exit Sub 'minimum 500?
            Else
